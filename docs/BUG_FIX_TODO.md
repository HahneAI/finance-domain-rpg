...
DW-1 through DW-12 and DW-14 through DW-15 are all fixed — see the Fixed
table below. DW-13 (Bulk Edit's unreachable trigger) is open, awaiting a
product decision. New findings beyond DW-15 get filed here as DW-16+.
