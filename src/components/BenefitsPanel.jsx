    ...
    <div style={{ marginBottom: "24px" }}>
      ...
      <div style={{ background: avail >= 134 ? "#1a2d1e" : "#2d1a1a", border: `1px solid ${avail >= 134 ? "var(--color-green)" : "var(--color-red)"}`, borderRadius: "6px", padding: "14px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "8px" }}>
          <div><div style={{ fontSize: "11px", color: avail >= 134 ? "var(--color-green)" : "var(--color-red)", fontWeight: "bold", marginBottom: "4px" }}>Paternity Leave Plan</div><div style={{ fontSize: "11px", color: "#888" }}>Need ~134 hrs · {adjP.toFixed(1)} accrued + 40 neg = <strong style={{ color: "var(--color-text-primary)" }}>{avail.toFixed(1)} available</strong></div></div>
    ...
    {bucketModel && (() => {
      ...
      return (
        <div style={{ marginBottom: "24px" }}>
          ...
          {/* Current month strip */}
          <div style={{ background: "var(--color-bg-surface)", border: "1px solid #222", borderRadius: "6px", padding: "10px 14px", marginBottom: "10px", fontSize: "11px" }}>
            ...
            <table className="data-table" style={{ width: "100%", borderCollapse: "collapse", fontSize: "11px" }}>
              ...
              <tbody>
                ...
                <tr style={{ borderBottom: "1px solid #252525", background: "var(--color-bg-surface)" }}>
                  <td style={{ padding: "7px 12px", color: "var(--color-gold)" }}>{fmtMonth(currentMonthStr)} <span style={{ fontSize: "9px", color: "#555" }}>in progress</span></td>
