      ...
      <div style={{ position: "fixed", inset: 0, zIndex: 280, background: "rgba(0,0,0,0.85)", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px 16px" }}>
        <div style={{ width: "100%", maxWidth: "440px", background: "var(--color-bg-surface)", border: "1px solid var(--color-border-accent)", borderRadius: "16px", padding: "24px", display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <label style={{ display: "flex", alignItems: "flex-start", gap: "10px", cursor: "pointer" }}>
            ...
            />
            <span className="text-sm" style={{ color: "var(--color-text-secondary)", lineHeight: "1.6" }}>
          ...
          <Pressable
            ...
            className="text-xs" style={{ background: "var(--color-teal)", color: "var(--color-bg-base)", border: "none", borderRadius: "12px", padding: "11px 0", letterSpacing: "2px", textTransform: "uppercase", fontWeight: "bold", opacity: !agreed ? 0.5 : 1 }}
          >
            {agreeLoading ? "..." : "Agree and Continue"}
          </Pressable>
          <button type="button" onClick={onSignOut} className="text-xs" style={{ background: "transparent", border: "none", color: "var(--color-text-secondary)", cursor: "pointer", textDecoration: "underline", alignSelf: "center" }}>
            Sign out instead
          </button>
        </div>
      </div>
