  ...
  return (
    <>
      ...
      <button
        ...
        style={{ width: "100%", padding: "14px 16px", background: "var(--color-bg-surface)", border: "1px solid rgba(224,92,92,0.3)", borderRadius: "12px", color: "var(--color-red)", fontSize: "13px", fontWeight: "600", cursor: "pointer", textAlign: "center" }}
      >
        Sign Out
      </button>
    </>
