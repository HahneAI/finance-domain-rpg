...
export const iS = { background: "#0d0d0d", border: "1px solid #333", color: "#ddd8cc", padding: "7px 9px", borderRadius: "3px", fontSize: "16px", fontFamily: "'Courier New',monospace", width: "100%", boxSizing: "border-box" };
...
export function SH({ children, color, right }) { const c = color || "#c8a84b"; return <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px", marginTop: "4px" }}><div style={{ display: "flex", alignItems: "center", gap: "12px" }}><div style={{ width: "3px", height: "18px", background: c, borderRadius: "2px", flexShrink: 0 }} /><div style={{ fontSize: "11px", letterSpacing: "3px", color: c, textTransform: "uppercase", fontFamily: "'Courier New',monospace", fontWeight: "bold" }}>{children}</div></div>{right != null && <div style={{ fontSize: "12px", color: c, fontFamily: "'Courier New',monospace", fontWeight: "bold" }}>{right}</div>}</div>; }
