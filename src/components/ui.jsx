...
// eslint-disable-next-line react-refresh/only-export-components
export const lS = { fontSize: "12px", letterSpacing: "2px", color: "var(--color-text-disabled)", textTransform: "uppercase", marginBottom: "4px", display: "block", fontFamily: "var(--font-sans)" };
