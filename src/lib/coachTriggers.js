// §2.C — Net Worth Trend Mental Health Trigger. Pure, side-effect-free signal
...
// the literal spec in docs/TODO.md §2.C, since a few of those conditions need
...
// See docs/TODO.md §2.C for the full/faithful spec and what's deferred.
//
