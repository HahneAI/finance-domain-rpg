...
describe('EVENT_TYPES', () => {
  const EXPECTED_TYPES = ['missed_unpaid', 'missed_unapproved', 'pto', 'pto_unapproved', 'partial', 'bonus', 'tips_commission', 'other_loss']

  it('contains all 8 expected event type keys', () => {
